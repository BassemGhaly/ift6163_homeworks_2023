...
from roble.policies.MLP_policy import MLPPolicyPG
from roble.infrastructure.replay_buffer import ReplayBuffer
from roble.infrastructure.utils import normalize
import rospy
...
class PGAgent(BaseAgent):
    def __init__(self, env, agent_params):
        ...
        rospy.logwarn(self.agent_params['ac_dim'])
        rospy.logwarn(self.agent_params['ob_dim'])
        rospy.logwarn(self.agent_params['n_layers'])
        rospy.logwarn(self.agent_params['size'])
        # actor/policy
